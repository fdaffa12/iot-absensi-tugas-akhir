...
<head>
	...
	<title>Halaman Admin - SMP Riyadhul Jannah</title>
	<link rel="stylesheet" href="resources/css/bootstrap.min.css">
	<style>
	.asup {
		background-image:url(resources/images/logorj.jpg);
		...
		<div class="row justify-content-center">
			<div class="col-md-4">
				<div class="card shadow">
					...
					<center>
						<img src="resources/images/rj.png" width="80%" alt="" srcset="">
					</center>
					</div>
					<div class="card-body">
						...
						<form action="proses_login.php" method="POST">
							...
							<hr>
							<center>
								<small>Distributed By <a href="https://blogbugabagi.blogpot.com" target="_blank" rel="noopener noreferrer">BlogBugaBagi</a></small>
							</center>
						</form>
					</div>
				</div>
