          ...
          <!-- Add icons to the links using the .nav-icon class
              ...
              <li class="nav-item" style="border-bottom: 1px solid #4b545c;">
                <a href="../#" class="nav-link" style="border-radius: 24px 4px;">
                  <img src="../dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image" style="width: 2.1rem;">
                  <p>
                    Faiz Daffa
              ...
              <li class="nav-item">
               ...
               <li class="nav-item <?php if($open=='dashboard'){echo 'menu-open';} ?>">
                ...
                <li class="nav-item <?php if($open=='data_master'){echo 'menu-open';} ?>">
                  <a href="../#" class="nav-link" style="border-radius: 24px 4px;">
                    <i class="nav-icon fas fa-tachometer-alt"></i>
                    <p>
                      Data Master
                  ...
                  <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item <?php if($page=='jurusan'){echo 'aktif';} ?>">
                      <a href="../jurusan/index.php" class="nav-link" style="border-radius: 24px 4px;">
                        <i class="fas fa-database nav-icon"></i>
                        <p>Data Jurusan</p>
                      </a>
                    </li>
