	...
	<div class="container-fluid">
		...
		<table class="table table-brodered">
			...
			<tbody>
				...
				$sql = mysqli_query($konek, "select b.nama, a.tanggal, a.jam_masuk, a.jam_istirahat, a.jam_kembali, a.jam_pulang from absensi a, murid b where a.nokartu=b.nokartu and a.tanggal='$tanggal'");
